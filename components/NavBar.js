...
const NavBar = ({ navbarState, setNavbarState }) => {
    ...
    return (
        ...
        <View style={styles.container}>
            <View style={styles.button}>
                <TouchableOpacity onPress={() => setNavbarState("calendar")} className={navbarState == "calendar" ? selected : unselected}>
            ...
            <View className={buttonStyle}>
                <TouchableOpacity onPress={() => setNavbarState("map")} className={navbarState == "map" ? selected : unselected}>
            ...
            <View className={buttonStyle}>
                <TouchableOpacity onPress={() => setNavbarState("saved")} className={navbarState == "saved" ? selected : unselected}>
